    ...
    columnDefs: [{ // 定义表格样式
        ...
        render: function (data, type, row, meta) {
            return '<td class="text-l"><u style="cursor:pointer" class="text-primary"' +
                'onClick="house_edit(\'查看\', \'/admin/house/edit?id=' + data + '\')" title="查看">' + data + '</u></td>';
        }
    }, {
        targets: 1,
        render: function (data, type, row, meta) {
            return '<td class="text-l"><u style="cursor:pointer" class="text-primary"' +
                'onClick="house_edit(\'查看\', \'/admin/house/edit?id=' + row.id + '\')" title="查看">' + data + '</u></td>';
        }
    }, {
        targets: 2,
        render: function (data, type, row, meta) {
            return '<td><img onClick="house_edit(\'查看\', \'/admin/house/edit?id=' + row.id + '\')" title="查看"' +
